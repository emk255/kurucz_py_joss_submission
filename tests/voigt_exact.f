      ...
      WRITE(6,*) 'VOIGT TESTS:'
      WRITE(6,100) 0.,0.,VOIGT(0.,0.)
      WRITE(6,100) 1.,.5,VOIGT(1.,.5)
      WRITE(6,100) 10.,1.,VOIGT(10.,1.)
      WRITE(6,100) 0.,1.,VOIGT(0.,1.)
      WRITE(6,100) 1.,0.1,VOIGT(1.,0.1)
      WRITE(6,100) 2.,1.,VOIGT(2.,1.)
      WRITE(6,100) 5.,0.1,VOIGT(5.,0.1)
      WRITE(6,100) .5,.01,VOIGT(.5,.01)
